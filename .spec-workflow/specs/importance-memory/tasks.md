...
- [ ] 2. storage/formatter.ts にimportance出力を追加 + テスト
...
- [ ] 3. storage/parser.ts にimportanceパースを追加 + テスト
...
- [ ] 4. MarkdownStorage.save() にimportance反映を追加
...
- [ ] 5. memory_saveツールにimportanceパラメータを追加
...
- [ ] 6. analysis.txtプロンプトにimportance判定を追加
...
- [ ] 7. cli/analyze.ts でAnalysisResult.importanceをSaveParamsに伝播
...
- [ ] 8. consolidate-worker.ts でcriticalエントリを統合から除外
...
- [ ] 10. 統合テスト: importance保存→統合除外→3層注入のE2Eテスト
